...
summary: "Clients limit us to 2-3 P4 machines per project, making delivery a manual bottleneck. I built an internal P4 mirror and Python tools that push reviewed assets from artist workspaces to client depots in one changelist."
...
```
Loaded 6 users from \\[SERVER_LOCATION]\Pipeline\Library\Data\Data_Computer_AUTO.csv
Connected to Perforce server
Updated workspace: user.A.01_XX-PC-09_[projectA]
Updated workspace: user.A.01_XX-PC-09_[projectB]
Updated workspace: user.A.01_XX-PC-09_[projectC]
Updated workspace: user.A.01_XX-PC-09_[projectD]
Updated workspace: user.B.01_XX-PC-11_[projectA]
Updated workspace: user.B.01_XX-PC-11_[projectB]
Updated workspace: user.B.01_XX-PC-11_[projectC]
Updated workspace: user.B.01_XX-PC-11_[projectD]
Updated workspace: user.C.01_XX-PC-14_[projectA]
Updated workspace: user.C.01_XX-PC-14_[projectB]
Updated workspace: user.C.01_XX-PC-14_[projectC]
Updated workspace: user.C.01_XX-PC-14_[projectD]
Updated workspace: user.D.01_XX-PC-22_[projectA]
Updated workspace: user.D.01_XX-PC-22_[projectB]
Updated workspace: user.D.01_XX-PC-22_[projectC]
Updated workspace: user.D.01_XX-PC-22_[projectD]
Updated workspace: user.E.02_XX-PC-42_[projectA]
Updated workspace: user.E.02_XX-PC-42_[projectB]
Updated workspace: user.E.02_XX-PC-42_[projectC]
Updated workspace: user.E.02_XX-PC-42_[projectD]
Updated workspace: user.F.01_XX-PC-50_[projectA]
Updated workspace: user.F.01_XX-PC-50_[projectB]
Updated workspace: user.F.01_XX-PC-50_[projectC]
Updated workspace: user.F.01_XX-PC-50_[projectD]
...
*Sensitive data obscured for demonstration purposes*
```
